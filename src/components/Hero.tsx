    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 max-w-4xl mx-auto px-4 text-center text-white py-32">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-black leading-tight mb-4">
          <span className="text-white">Placencia</span>{' '}
          <span className="text-accent">Greenscapes</span>
        </h1>
        <p className="text-xl md:text-2xl font-bold text-white/90 mb-2">& Stone</p>

        <p className="text-base md:text-lg text-white/70 max-w-xl mx-auto mb-10 leading-relaxed">
          Transforming outdoor spaces across the Placencia peninsula. Expert garden design,
          stone craftsmanship, and tree care since 2015.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-full bg-accent px-8 py-4 text-base font-bold text-white hover:bg-accent-dark transition-all hover:scale-105 shadow-lg"
          >
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-6 text-white/50 text-sm">
          <span className="flex items-center gap-1.5"><span className="text-accent">✓</span> Licensed & Insured</span>
          <span className="flex items-center gap-1.5"><span className="text-accent">✓</span> Free Consultations</span>
          <span className="flex items-center gap-1.5"><span className="text-accent">✓</span> 10+ Years Experience</span>
        </div>
      </div>
